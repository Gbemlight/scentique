...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div onClick={handleNavigate} className="group cursor-pointer h-full flex flex-col">
      {/* IMAGE WRAPPER - Smooth Zoom on Hover with Overflow Hidden */}
      <div className="relative overflow-hidden rounded-lg bg-cream-50 shrink-0">
        ...
        {/* WISHLIST HEART - Top Right with Bounce Animation */}
        <button
        ...
        {/* ADD TO CART - Mobile Always Visible, Desktop Hover Slide Up */}
      ...
      {/* Mobile Add to Cart Button - Visible on small screens only */}
      <button
        onClick={handleAddToCart}
...
/**
 * StarRating Component - Read-only display
 */
...
/**
 * ProductCardSkeleton - Loading variant with cream-tone shimmer (not gray)
 */
export function ProductCardSkeleton() {
  return (
    <div className="h-full flex flex-col">
      {/* Image skeleton with cream-tone gradient */}
      ...
      <div className="mt-4 space-y-3 flex-1 flex flex-col">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-5 w-3/4 bg-linear-to-r from-cream-50 to-neutral-100 rounded animate-pulse" style={{
